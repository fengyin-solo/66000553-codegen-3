...
export interface SchemeParams { lowerPrice: number; upperPrice: number; gridCount: number; capitalPerGrid: number }
export interface GridScheme { name: string; params: SchemeParams; enabled: boolean }
